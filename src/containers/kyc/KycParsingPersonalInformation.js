...
class KycParsingPersonalInformation extends Component {
    state = {
        selectedDate: ((this.props.existingDataID.DOB && new Date(this.props.existingDataID.DOB)) || new Date()).toDateString()
    };
                ...
                <div className="ga-plr20">
                    <div className="row">
                        <div className="col-6">
                            ...
                            <input type="text" className="form-control" id="kycFirstName" name="kycFirstName" defaultValue={existingDataID.firstName} required/>
                        </div>

                        <div className="col-6">
                            <label htmlFor="kycLastName">Last Name</label>
                            <input type="text" className="form-control" id="kycLastName" name="kycLastName" defaultValue={existingDataID.lastName} required/>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-4">
                            ...
                            <select className="form-control" id="kycGender" name="kycGender" defaultValue={existingDataID.gender} required>
                        ...
                        <div className="col-8">
                            ...
                            <input type="text" className="form-control" id="kycBirthDate" name="kycBirthDate" value={this.getDateString()} readOnly required/>
                            <i className="fa fa-calendar-plus-o ga-datepicker" id="kycDatepicker" aria-hidden="true" onClick={this.showDatePicker}/>
                        </span>
                        </div>
                    </div>

                    <label htmlFor="kycCountry">Country of Citizenship</label>
                    <select className="form-control countrypicker" id="kycCountry" name="kycCountry" defaultValue={existingDataID.nationality}>
                        {this.getCountryList()}
                    </select>
