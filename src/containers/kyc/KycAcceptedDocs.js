            ...
            case "POA":
                return (
                    <div>
                        ...
                        {window.location.href.includes("intro")
                            ? (
                                <ul>
                                    ...
                                    <li><img src="assets/images/vv.png" alt="" /> Credit card statement</li>
                                    <p className="hidden-md-up">Please make sure your document is no more than 3 months old!</p>
                                </ul>
                            )
                            : (
                                <form ref={(form) => this.form = form}>
                        ...
                        <p className="hidden-sm-down">Please make sure your document is no more than 3 months old!</p>
                    </div>
                );
            case "FACE":
                return (
