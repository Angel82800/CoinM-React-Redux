...
class ExchangeBuy extends Component {
  ...
  setSpan = (m, b) => {
    ...
    this.stxx[pos].setSpan({ multiplier: m, base: b });
  };
  ...
  render() {
    ...
    return (
      <div id={"ex-buy-range-" + pos} className="exchange-buy-con">
        ...
        <h2 className="noselect">{crypto.rateUSD && crypto.rateUSD.toPrecision(4)} US$</h2>
        </div>
          ...
          <div className="exchange-navigation-box">
            ...
            <div className="exchange-navigation-top d-flex">
              ...
              <div className="ml-auto">
                ...
                <p>
                  <span className="op5">{crypto.rateBTC && crypto.rateBTC.toPrecision(4)}</span>
