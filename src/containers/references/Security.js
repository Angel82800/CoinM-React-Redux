...
class ReferenceSecurity extends Component {
        ...
        AuthyOptions.forEach(opt => {
            result.push(
                <div key={opt.code} className={`col ${(this.state.authy[opt.code]) ? "ga-sw-active" : ""}`}
                     onClick={() => this.toggleChangeAuthy(opt.code)}>
                    <span>{opt.text}</span>
    ...
    voiceAuthOptions = () => {
        ...
        const result = [];
        VoiceAuthOptions.forEach(opt => {
            result.push(
                <div key={opt.code} className={`col ${(this.state.voiceAuth[opt.code]) ? "ga-sw-active" : ""}`}
                     onClick={() => this.toggleChangeVoiceAuth(opt.code)}>
                    <span>{opt.text}</span>
                    {
                        <div className="ga-auth-sw">
                            <div className={`ga-sw-circle ${(this.state.voiceAuth[opt.code]) ? "ga-sw-anim" : ""}`}/>
                        </div>
                    }
                </div>
            )
    ...
    render() {
        ...
        return (
            <div className="ga-sec-content pt-4">
                <div className="row ga-auth" id="ga-auth-settings">
                    ...
                    <div className="col-lg-6 offset-lg-1 ga-posr pl-5">
                ...
                <div className="row ga-auth">
                    ...
                    <div className="col-lg-6 offset-lg-1 ga-posr pl-5 ga-sec-voice-m">
                        <div className="ga-sec-i"><img src="assets/images/info.png"/></div>
