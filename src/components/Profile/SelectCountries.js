...
const SelectCountries = ({ accredited, citizenship, residence }) => {
    const getCountryList = () => {
        ...
        Object.keys(countries).forEach(function (countryCode, index) {
            result.push(
                <option key={index} value={countryCode}>{countries[countryCode].name}</option>
            );
        });
        return result;
    };
        ...
        <div className="form-group">
            <div className="ga-posr">
                <div className="justify-content-center align-items-center">
                    ...
                    <select className="form-control countrypicker" id="residence" name="residence" defaultValue={residence}>
                        {getCountryList()}
                    </select>
                </div>
                ...
                <div className="justify-content-center align-items-center">
                    ...
                    <select className="form-control countrypicker" id="citizenship" name="citizenship" defaultValue={citizenship}>
                        {getCountryList()}
                    </select>
                </div>
